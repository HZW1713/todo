...
const file_todo_v1_eliza_proto_rawDesc = "" +
	...
	"\fElizaService\x122\n" +
	"\x03Say\x12\x13.todo.v1.SayRequest\x1a\x14.todo.v1.SayResponse\"\x00Br\n" +
	"\vcom.todo.v1B\n" +
	"ElizaProtoP\x01Z\x1aexample/gen/todo/v1;todov1\xa2\x02\x03TXX\xaa\x02\aTodo.V1\xca\x02\aTodo\\V1\xe2\x02\x13Todo\\V1\\GPBMetadata\xea\x02\bTodo::V1b\x06proto3"
